const apiURL2 = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=6d1d830097a2c0bac1aba2337d0139e6";
...
.then((jsonObject) => {
  ...
  window.addEventListener("load", (event)=>{ 
    ...
    const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=6d1d830097a2c0bac1aba2337d0139e6";
